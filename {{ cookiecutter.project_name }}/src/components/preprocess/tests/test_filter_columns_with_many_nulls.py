...
class TestFilterColumnsWithManyNulls(unittest.TestCase):
    ...
    def test_call(self):
        ...
        self.assertEqual(len(filtered_df.columns), 3)  # Only col3 and col4 should remain
    ...
    def test_call_with_threshold(self):
        ...
        self.assertEqual(len(filtered_df.columns), 3)  # col3 should remain as it has less than 50% nulls
